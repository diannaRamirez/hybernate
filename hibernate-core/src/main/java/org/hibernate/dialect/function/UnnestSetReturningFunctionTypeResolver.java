...
public class UnnestSetReturningFunctionTypeResolver implements SetReturningFunctionTypeResolver {
	...
	protected final String defaultBasicArrayColumnName;

	public UnnestSetReturningFunctionTypeResolver(String defaultBasicArrayColumnName) {
		this.defaultBasicArrayColumnName = defaultBasicArrayColumnName;
	}

	@Override
	public AnonymousTupleType<?> resolveTupleType(List<? extends SqmTypedNode<?>> arguments) {
	...
	@Override
	public SelectableMapping[] resolveFunctionReturnType(List<? extends SqlAstNode> arguments) {
		...
		if ( elementType.getJdbcType() instanceof AggregateJdbcType aggregateJdbcType
			...
			final String elementSelectionExpression = defaultBasicArrayColumnName;
