...
public class SelfRenderingSqmSetReturningFunction<T> extends SqmSetReturningFunction<T> {
	...
	public TableGroup convertToSqlAst(
		...
		final SelectableMapping[] selectableMappings = getSetReturningTypeResolver().resolveFunctionReturnType( arguments );
	...
	private record SetReturningFunctionExpression(
		...
		public void renderToSql(
			...
			functionRenderer.render( sqlAppender, arguments, tableGroupProducer, walker );
		}
